...
These APIs are secured by the OAuth 2.0 client credentials flow using the [Authorization-API](https://docs.api.europace.de/common/authentication/authorization-api/). To use these APIs your OAuth2-Client needs
